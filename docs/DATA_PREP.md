...
Our code is based on UniAD. We provide a coarse description below, and more detail can be found in [UniAD](https://github.com/OpenDriveLab/UniAD/blob/main/docs/DATA_PREP.md)
...
*Please make sure the structure of GraphBEV++ is as follows:*
```
GraphBEV++
├── projects/
├── tools/
