...
class BEVFormerEncoder(TransformerLayerSequence):
    ...
    def point_sampling(self, reference_points, pc_range,  img_metas):
        ...
        reference_points = torch.cat( # [x, y, z, 1]
            (reference_points, torch.ones_like(reference_points[..., :1])), -1)

        reference_points = reference_points.permute(1, 0, 2, 3) # [b, num_points, num_bev_pixel, 4] --> [num_points, b, num_bev_query, 4]
        ...
        reference_points_cam = reference_points_cam[..., 0:2] / torch.maximum(
            reference_points_cam[..., 2:3], torch.ones_like(reference_points_cam[..., 2:3]) * eps) # x/z*eps y/z*eps --> [4, 1, 6, 40000, 2]
        ...
        reference_points_cam = reference_points_cam.permute(2, 1, 3, 0, 4) # -->[num_cam, batch_size, num_query, 4, 2]
    ...
    def spatial_alignment_noise(self, ori_pose, severity=1):
        ...
        '''
        # print(f'alignment severity:{severity}!!!')
    ...
    def forward(self,
        ...
        output = bev_query
        intermediate = []
        ref_3d = self.get_reference_points( # [1, 4, 40000, 3]
            bev_h, bev_w, self.pc_range[5]-self.pc_range[2], self.num_points_in_pillar, dim='3d', bs=bev_query.size(1),  device=bev_query.device, dtype=bev_query.dtype) 
        ref_2d = self.get_reference_points( # [1, 40000, 1, 2]
