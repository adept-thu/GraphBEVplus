...
model = dict(
    ...
    freeze_bev_encoder=True, # default
    # freeze_bev_encoder=False, # for graph_bev 
            ...
            encoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        ...
                        # dict(
                        #     type="SpatialCrossAttentionGraph",
                        #     pc_range=point_cloud_range,
                        #     deformable_attention=dict(
                        #         type="MSDeformableAttention3D",
                        #         embed_dims=_dim_,
                        ...
                        #         num_levels=_num_levels_,
                        #     ),
                        #     k_graph = k_graph, # number of graph node
                        #     embed_dims=_dim_,
                        # ),
                        dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='./UniAD/data/others/motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
    ...
    planning_head=dict(
        ...
        loss_collision=[dict(type='CollisionLoss', delta=0.0, weight=5.0),
                        dict(type='CollisionLoss', delta=0.5, weight=2.0),
                        dict(type='CollisionLoss', delta=1.0, weight=1.0)],
...
load_from = 'ckpts/fusion_latest.pth'
work_dir = './work_dirs/'
find_unused_parameters = True
resume_from = '/data/songziying/workspace/FusionAD/projects/work_dirs/stage2_e2e/graph_bev_train/epoch_1.pth'